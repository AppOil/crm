...
//			$this->categoryList = $categoryList;
	...
	public function excelExport($productList=false){
		...
		$objProps->setCreator("appoil");
		$objProps->setLastModifiedBy("appoil");
		$objProps->setTitle("appoil Product");
		$objProps->setSubject("appoil Product Data");
		$objProps->setDescription("appoil Product Data");
		$objProps->setKeywords("appoil Product");
		$objProps->setCategory("appoil");
        ...
        header("Content-Disposition:attachment;filename=appoil_product_".date('Y-m-d',mktime()).".xls");
	...
	public function excelImportDownload(){
		...
		$objProps->setSubject("appoil Product Data");
		$objProps->setDescription("appoil Product Data");
		$objProps->setKeywords("appoil Product Data");
		$objProps->setCategory("appoil");
		$objPHPExcel->setActiveSheetIndex(0);     
		$objActSheet = $objPHPExcel->getActiveSheet(); 
		...
		$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel5');
		header("Content-Type: application/vnd.ms-excel;");
        header("Content-Disposition:attachment;filename=appoil_product.xls");
        header("Pragma:no-cache");
        header("Expires:0");
        $objWriter->save('php://output'); 
    }

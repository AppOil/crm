...
class TaskAction extends Action{
	...
	**/
	...
	public function excelExport($taskList=false){
		...
		$objProps->setTitle("appoil Task Data");
		$objProps->setSubject("appoil Task Data");
		$objProps->setDescription("appoil Task Data");
		$objProps->setKeywords("appoil Task Data");
        ...
        header("Content-Disposition:attachment;filename=appoil_task_".date('Y-m-d',mktime()).".xls");

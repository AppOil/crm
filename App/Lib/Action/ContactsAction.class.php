...
class ContactsAction extends Action {
	...
	public function excelExport($contactsList){
		...
		$objProps->setTitle("appoil Contact");
		$objProps->setSubject("appoil Contact Data");
		$objProps->setDescription("appoil Contact Data");
		$objProps->setKeywords("appoil Contact");
        ...
        header("Content-Disposition:attachment;filename=appoil_contacts_".date('Y-m-d',mktime()).".xls");

...
class EventAction extends Action{
			...
			if($m_event->create()){
				...
				if($event_id = $m_event->add()){
					...
					if($_POST['send_email']) {
						...
						$send =  SendMail($to_user['email'],L('APPOIL_NOTIFICATIONS'),$content,L('APPOIL_SYS'));
					}
	...
	**/
	...
	public function excelExport($eventList=false){
		...
		$objProps->setTitle("appoil Event Data");
		$objProps->setSubject("appoil Event Data");
		$objProps->setDescription("appoil Event Data");
		$objProps->setKeywords("appoil Event Data");
        ...
        header("Content-Disposition:attachment;filename=appoil_event_".date('Y-m-d',mktime()).".xls");

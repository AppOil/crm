...
class BusinessAction extends Action{
	...
	**/
	public function excelExport($businessList=false){
		...
		$objProps->setTitle("appoil Business Data");
		$objProps->setSubject("appoil Business Data");
		$objProps->setDescription("appoil Business Data");
		$objProps->setKeywords("appoil Business Data");
        ...
        header("Content-Disposition:attachment;filename=appoil_business_".date('Y-m-d',mktime()).".xls");

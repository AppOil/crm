...
class KnowledgeAction extends Action{
	...
	public function excelExport($knowledgeList=false){
		...
		$objProps->setTitle("appoil Konwledge");
		$objProps->setSubject("appoil Konwledge Data");
		$objProps->setDescription("appoil Konwledge Data");
		$objProps->setKeywords("appoil Konwledge");
        ...
        header("Content-Disposition:attachment;filename=appoil_knowledge_".date('Y-m-d',mktime()).".xls");

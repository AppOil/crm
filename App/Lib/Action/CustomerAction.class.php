...
class CustomerAction extends Action {
	...
	*/
	...
	public function excelExport($customerList=false){
		...
		$objProps->setTitle("appoil Customer");
		$objProps->setSubject("appoil Customer Data");
		$objProps->setDescription("appoil Customer Data");
		$objProps->setKeywords("appoil Customer Data");
        ...
        header("Content-Disposition:attachment;filename=appoil_customer_".date('Y-m-d',mktime()).".xls");
	...
	**/
    public function excelImportDownload(){
		...
		ob_end_clean();
		header("Content-Type: application/vnd.ms-excel;");
        header("Content-Disposition:attachment;filename=appoil_customer.xls");
        header("Pragma:no-cache");
        header("Expires:0");
        $objWriter->save('php://output'); 
    }

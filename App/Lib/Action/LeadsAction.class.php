...
class LeadsAction extends Action{
	...
	public function excelExport($leadsList=false){
		...
		$objProps->setTitle("appoil Leads Data");
		$objProps->setSubject("appoil Leads Data");
		$objProps->setDescription("appoil Leads Data");
		$objProps->setKeywords("appoil Leads Data");
        ...
        header("Content-Disposition:attachment;filename=appoil_leads_".date('Y-m-d',mktime()).".xls");
 	...
 	public function excelImportDownload(){
		...
		$objProps->setCreator("appoil");
		$objProps->setLastModifiedBy("appoil");
		$objProps->setTitle("appoil leads");
		$objProps->setSubject("appoil leads Data");
		$objProps->setDescription("appoil leads Data");
		$objProps->setKeywords("appoil leads Data");
		...
		$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel5');
		header("Content-Type: application/vnd.ms-excel;");
        header("Content-Disposition:attachment;filename=appoil_leads.xls");
        header("Pragma:no-cache");
        header("Expires:0");
        $objWriter->save('php://output'); 
    }

    ...
    <div class="container">
      <form action="" method="post" class="form-signin">
		<fieldset>
			...
			<div class="row-fluid appoil">
				<div class="span3"><img style="height:50px;" src="./Public/img/logo_img.png" alt="CRM"/></div>
				<div class="span9">
					<p>CRM &copy; CRM Limited Company 2015</p>
					<p><small>
						<a href="http://appoil.com/index.php?m=doc" target="_blank">使用帮助</a>
						<span class="muted">&middot;</span>
						<a href="http://www.appoil.com/" target="_blank">技术支持</a>
						<span class="muted">&middot;</span>
						<a href="http://www.appoil.com" target="_blank">联系我们</a>
					</small></p>
				</div>
			</div>
      </form>

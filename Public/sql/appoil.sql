...
CREATE TABLE IF NOT EXISTS `appoil_action_log` (
...
CREATE TABLE IF NOT EXISTS `appoil_announcement` (
...
CREATE TABLE IF NOT EXISTS `appoil_business` (
...
CREATE TABLE IF NOT EXISTS `appoil_business_data` (
...
CREATE TABLE IF NOT EXISTS `appoil_business_status` (
...
INSERT INTO `appoil_business_status` (`status_id`, `name`, `order_id`, `is_end`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `appoil_business_status_flow` (
...
CREATE TABLE IF NOT EXISTS `appoil_comment` (
...
CREATE TABLE IF NOT EXISTS `appoil_config` (
...
INSERT INTO `appoil_config` (`name`, `value`, `description`) VALUES
('defaultinfo', 'a:8:{s:4:"name";s:9:"CRM";s:11:"description";s:39:"开源免费的客户关系管理系统";s:5:"state";s:9:"河南省";s:4:"city";s:9:"郑州市";s:15:"allow_file_type";s:40:"pdf,doc,jpg,png,gif,txt,doc,xls,zip,docx";s:19:"contract_alert_time";i:30;s:10:"task_model";s:1:"2";s:4:"logo";N;}', ''),
...
CREATE TABLE IF NOT EXISTS `appoil_contacts` (
...
CREATE TABLE IF NOT EXISTS `appoil_contract` (
...
CREATE TABLE IF NOT EXISTS `appoil_control` (
...
INSERT INTO `appoil_control` (`control_id`, `module_id`, `name`, `m`, `a`, `parameter`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `appoil_control_module` (
...
INSERT INTO `appoil_control_module` (`module_id`, `name`, `description`) VALUES
(2, '商机模块', '关于一切商机操作的模块'),
(3, '产品模块', '关于产品操作的模块'),
(5, '客户模块', '客户的管理'),
(6, '权限模块', '用户的权限管理'),
...
CREATE TABLE IF NOT EXISTS `appoil_customer` (
...
CREATE TABLE IF NOT EXISTS `appoil_customer_data` (
...
CREATE TABLE IF NOT EXISTS `appoil_customer_attribute` (
...
CREATE TABLE IF NOT EXISTS `appoil_customer_attribute_group` (
...
CREATE TABLE IF NOT EXISTS `appoil_customer_attribute_relation` (
...
CREATE TABLE IF NOT EXISTS `appoil_customer_cares` (
...
CREATE TABLE IF NOT EXISTS `appoil_customer_record` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `appoil_event` (
...
CREATE TABLE IF NOT EXISTS `appoil_fields` (
...
INSERT INTO `appoil_fields` ( `model`, `is_main`, `field`, `name`, `form_type`, `default_value`, `color`, `max_length`, `is_unique`, `is_null`, `is_validate`, `in_index`, `in_add`, `input_tips`, `setting`, `order_id`, `operating`) VALUES
...
CREATE TABLE IF NOT EXISTS `appoil_file` (
...
CREATE TABLE IF NOT EXISTS `appoil_finance` (
...
CREATE TABLE IF NOT EXISTS `appoil_knowledge` (
...
CREATE TABLE IF NOT EXISTS `appoil_knowledge_category` (
...
CREATE TABLE IF NOT EXISTS `appoil_leads` (
...
CREATE TABLE IF NOT EXISTS `appoil_leads_data` (
...
CREATE TABLE IF NOT EXISTS `appoil_leads_record` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `appoil_log` (
...
CREATE TABLE IF NOT EXISTS `appoil_log_category` (
...
INSERT INTO `appoil_log_category` (`category_id`, `name`, `order_id`, `description`) VALUES
(2, '月报', 3, '每月工作总结'),
(3, '周报', 2, '每周工作总结'),
(4, '日报', 1, '每日工作总结');
...
CREATE TABLE IF NOT EXISTS `appoil_message` (
...
CREATE TABLE IF NOT EXISTS `appoil_navigation` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `appoil_navigation` (`id`, `title`, `url`, `postion`, `listorder`, `module`) VALUES
(1, '线索', 'http://demo.appoil.com/index.php?m=leads', 'top', 0, 'Leads'),
(2, '客户', 'http://demo.appoil.com/index.php?m=customer', 'top', 1, 'Customer'),
(3, '商机', 'http://demo.appoil.com/index.php?m=business', 'top', 2, 'Business'),
(4, '产品', 'http://demo.appoil.com/index.php?m=product', 'top', 3, 'Product'),
(5, '任务', 'http://demo.appoil.com/index.php?m=task', 'top', 4, 'Task'),
(6, '日程', 'http://demo.appoil.com/index.php?m=event', 'top', 5, 'Event'),
(7, '合同', 'http://demo.appoil.com/index.php?m=contract', 'top', 6, 'Contract'),
(8, '财务', 'http://demo.appoil.com/index.php?m=finance', 'top', 7, 'Finance'),
(9, '日志', 'http://demo.appoil.com/index.php?m=log', 'more', 0, ''),
(10, '知识', 'http://demo.appoil.com/index.php?m=knowledge', 'more', 1, 'Knowledge'),
(11, '营销', 'http://demo.appoil.com/index.php?m=setting&a=sendsms', 'more', 2, ''),
(12, '站内信', 'http://demo.appoil.com/index.php?m=message', 'more', 3, ''),
(13, '我的面板', 'http://demo.appoil.com/', 'user', 0, ''),
(14, '个人资料', 'http://demo.appoil.com/index.php?m=user&a=edit', 'user', 1, ''),
(15, '组织架构', 'http://demo.appoil.com/index.php?m=user', 'user', 2, ''),
(16, '权限分配', 'http://demo.appoil.com/index.php?m=user&a=role', 'user', 3, 'Role'),
(17, '公告管理', 'http://demo.appoil.com/index.php?m=announcement', 'user', 4, 'announcement'),
(18, '操作日志', 'http://demo.appoil.com/index.php?m=action_log', 'user', 5, ''),
(19, '系统设置', 'http://demo.appoil.com/index.php?m=setting', 'user', 6, 'Setting');





CREATE TABLE IF NOT EXISTS `appoil_payables` (
...
CREATE TABLE IF NOT EXISTS `appoil_paymentorder` (
...
CREATE TABLE IF NOT EXISTS `appoil_permission` (
...
CREATE TABLE IF NOT EXISTS `appoil_position` (
...
INSERT INTO `appoil_position` (`position_id`, `parent_id`, `name`, `department_id`, `description`) VALUES
(1, 0, 'CEO', 1, '');


CREATE TABLE IF NOT EXISTS `appoil_product` (
...
CREATE TABLE IF NOT EXISTS `appoil_product_data` (
...
CREATE TABLE IF NOT EXISTS `appoil_product_attribute` (
...
CREATE TABLE IF NOT EXISTS `appoil_product_attribute_group` (
...
CREATE TABLE IF NOT EXISTS `appoil_product_attribute_relation` (
...
CREATE TABLE IF NOT EXISTS `appoil_product_category` (
...
INSERT INTO `appoil_product_category` (`category_id`, `parent_id`, `name`, `description`) VALUES
(1, 0, '默认', '');



CREATE TABLE IF NOT EXISTS `appoil_receivables` (
...
CREATE TABLE IF NOT EXISTS `appoil_receivingorder` (
...
CREATE TABLE IF NOT EXISTS `appoil_role` (
...
INSERT INTO `appoil_role` (`role_id`, `position_id`,`user_id`) VALUES
(1, 1, 1);



CREATE TABLE IF NOT EXISTS `appoil_role_department` (
...
INSERT INTO `appoil_role_department` (`department_id`, `parent_id`, `name`, `description`) VALUES
(1, 0, '办公室', '公司文档管理、财务管理');



CREATE TABLE IF NOT EXISTS `appoil_r_business_contract` (
  `id` int(10) NOT NULL,
  `business_id` int(10) NOT NULL COMMENT '商机id',
...
CREATE TABLE IF NOT EXISTS `appoil_r_business_customer` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `appoil_r_business_event` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `business_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `appoil_r_business_file` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `business_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `appoil_r_business_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `business_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `appoil_r_business_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `business_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `appoil_r_business_status` (
...
CREATE TABLE IF NOT EXISTS `appoil_r_business_task` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `business_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `appoil_r_contacts_customer` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `contacts_id` int(10) NOT NULL,
  `customer_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_contacts_event` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `contacts_id` int(10) NOT NULL,
  `event_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_contacts_file` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `contacts_id` int(10) NOT NULL,
  `file_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_contacts_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `contacts_id` int(10) NOT NULL,
  `log_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_contacts_task` (
  `id` int(10) NOT NULL,
  `contacts_id` int(10) NOT NULL,
  `task_id` int(10) NOT NULL
...
CREATE TABLE IF NOT EXISTS `appoil_r_contract_file` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `contract_id` int(10) NOT NULL COMMENT '合同id',
...
CREATE TABLE IF NOT EXISTS `appoil_r_contract_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `appoil_r_customer_event` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `customer_id` int(10) NOT NULL,
  `event_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_customer_file` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `customer_id` int(10) NOT NULL,
  `file_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_customer_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `customer_id` int(10) NOT NULL,
  `log_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_customer_task` (
  `id` int(10) NOT NULL,
  `customer_id` int(10) NOT NULL,
  `task_id` int(10) NOT NULL
...
CREATE TABLE IF NOT EXISTS `appoil_r_event_file` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `event_id` int(10) NOT NULL,
  `file_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_event_leads` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `event_id` int(10) NOT NULL,
  `leads_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_event_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `appoil_r_event_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `event_id` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `appoil_r_file_finance` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `file_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `appoil_r_file_leads` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `file_id` int(10) NOT NULL,
  `leads_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_file_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `file_id` int(10) NOT NULL,
  `log_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_file_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `file_id` int(10) NOT NULL,
  `product_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_file_task` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `file_id` int(10) NOT NULL,
  `task_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_file_user` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `appoil_r_finance_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `finance_id` int(10) NOT NULL,
  `log_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_leads_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `leads_id` int(10) NOT NULL,
  `log_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_leads_task` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `leads_id` int(10) NOT NULL,
  `task_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_log_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `log_id` int(10) NOT NULL,
  `product_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_log_task` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `task_id` int(10) NOT NULL,
  `log_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_log_user` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `log_id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_r_product_task` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `product_id` int(10) NOT NULL,
  `task_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `appoil_task` (
...
CREATE TABLE IF NOT EXISTS `appoil_user` (
...
CREATE TABLE IF NOT EXISTS `appoil_user_attribute` (
...
CREATE TABLE IF NOT EXISTS `appoil_user_attribute_group` (
...
CREATE TABLE IF NOT EXISTS `appoil_user_attribute_relation` (
...
CREATE TABLE IF NOT EXISTS `appoil_user_category` (
...
INSERT INTO `appoil_user_category` (`category_id`, `name`, `description`) VALUES
(1, '管理员', ''),
(2, '员工', '');


CREATE TABLE IF NOT EXISTS `appoil_sms_template` (
...
--
-- 导出表中的数据 `appoil_sms_template`
--

CREATE TABLE IF NOT EXISTS `appoil_email_template` (
  `template_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `subject` varchar(200) NOT NULL COMMENT '主题',
...
INSERT INTO `appoil_sms_template` (`template_id`, `subject`, `content`, `order_id`) VALUES
(1, '默认模板', '有一个特别的日子，鲜花都为你展现；有一个特殊的日期，阳光都为你温暖；有一个美好的时刻，百灵都为你欢颜；有一个难忘的今天，亲朋都为你祝愿；那就是今天是你的生日，祝你幸福安康顺意连年！', 1);

CREATE TABLE IF NOT EXISTS `appoil_user_smtp` (
...
CREATE TABLE IF NOT EXISTS `appoil_product_images` (
...
ALTER TABLE `appoil_contacts` DROP `owner_role_id`;

ALTER TABLE  `appoil_business` ADD  `total_amount` INT( 10 ) NOT NULL COMMENT  '产品总数' AFTER  `gain_rate` ,
...
ALTER TABLE  `appoil_r_business_product` ADD  `subtotal` FLOAT( 9, 2 ) NOT NULL COMMENT  '小计' AFTER  `amount` ,
...
ALTER TABLE  `appoil_contract` CHANGE  `price`  `price` DECIMAL( 10, 2 ) NOT NULL COMMENT  '总价';
ALTER TABLE  `appoil_payables` CHANGE  `price`  `price` DECIMAL( 10, 2 ) NOT NULL COMMENT  '应付金额';
ALTER TABLE  `appoil_paymentorder` CHANGE  `money`  `money` DECIMAL( 10, 2 ) NOT NULL COMMENT  '付款金额';
ALTER TABLE  `appoil_receivables` CHANGE  `price`  `price` DECIMAL( 10, 2 ) NOT NULL COMMENT  '应收金额';
ALTER TABLE  `appoil_receivingorder` CHANGE  `money`  `money` DECIMAL( 10, 2 ) NOT NULL COMMENT  '收款金额';

CREATE TABLE IF NOT EXISTS `appoil_sms_record` (
...
ALTER TABLE  `appoil_user` ADD  `last_read_time` VARCHAR( 500 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT  '商机等最后阅读时间';

CREATE TABLE IF NOT EXISTS `appoil_note` (
